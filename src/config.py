...
FIELD_REG_UPDATE_STRIDE_STABLE = 6   # frames to skip per Hough+RANSAC when locked
FIELD_REG_STABLE_STREAK = 8          # valid_streak depth considered stable
...
HEAD_ROI_FRAC = 0.28
HELMET_EVERY_DEFAULT = 2
HELMET_GATE_WINDOW = 6
HELMET_GATE_REQUIRED = 2
HELMET_GATE_GRACE = 5
HELMET_GATE_SOFT_LOCK_STREAK = 10
